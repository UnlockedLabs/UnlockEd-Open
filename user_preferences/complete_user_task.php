 ...
 * User tasks
 *
 * Handle completing user's tasks on dashboard
 *
 * PHP version 7.2.5
 *
 * @category  Tasks
...
$userTask->task_id = $_POST['taskId'];
$curentCompletion = $userTask->getTaskCompletion();
if ($curentCompletion == 0) {
    $userTask->checked = 1;
} else {
    $userTask->checked = 0;
}
$userTask->completeUserTask();
