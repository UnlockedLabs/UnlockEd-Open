...
$inboxResult = $email->readEmails();
$numMessages = $inboxResult->rowCount();
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    <ul class="nav nav-sidebar mb-2" data-nav-type="accordion">
                        ...
                        <li class="nav-item">
                            <a href="lc_inbox.php" class="nav-link active">
                    ...
                    <div class="navbar-collapse text-center flex-wrap collapse" id="inbox-toolbar-toggle-single">
                        <div class="mt-3 mt-lg-0">
                            ...
                            <div class="btn-group ml-3 mr-lg-3">
                                <button type="button" class="btn btn-light font-size-sm" onclick="markRead();"><i class="icon-mail-read"></i> <span class="d-none d-lg-inline-block ml-2">Mark read</span></button>
                                <button type="button" class="btn btn-light font-size-sm" onclick="markUnread();"><i class="icon-mail5"></i> <span class="d-none d-lg-inline-block ml-2">Mark unread</span></button>
                                <button type="button" class="btn btn-light font-size-sm" onclick="trashMessage();"><i class="icon-bin"></i> <span class="d-none d-lg-inline-block ml-2">Send to trash</span></button>
                            </div>
                        </div>
                ...
                <table class="table table-inbox">
                    <tbody data-link="row" class="rowlink">
                        ...
                        for ($m = 0; $m < $numMessages; $m++) {
                            $row = $inboxResult->fetch(\PDO::FETCH_ASSOC);
                            $id = $row['id'];
