...
$email = new Email($db);
$email->sender_ids = $user_id = $_SESSION['user_id'];
$email->sender_folder = 'sent';
$result = $email->readSentEmails();
                ...
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <ul class="nav nav-sidebar mb-2" data-nav-type="accordion">
                            ...
                            <li class="nav-item">
                                <a href="lc_sent.php" class="nav-link active"><i class="icon-drawer-out"></i> Sent messages</a>
                            </li>
                            <li class="nav-item">
