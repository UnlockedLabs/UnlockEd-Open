...
$timezone_setting_value = isset($_POST['timezoneSetting']) ?
    $_POST['timezoneSetting'] : die('ERROR: missing value.');
    
$setting->setting = 'timezone_setting';
$setting->value = $timezone_setting_value;
echo $setting->update();
