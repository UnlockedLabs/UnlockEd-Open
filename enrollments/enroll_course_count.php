...
if ($_GET) {
    ...
    $cohort_student_count = 0;

    while ($row = $stmt3->fetch(\PDO::FETCH_ASSOC)) {
        extract($row); // cohort_name, course_id, facilitator_id, course_name, student_id, username
    ...
    // get number of enrollments in course
    echo $cohort_student_count; //$cohort->countStudentsByCourse();
}
