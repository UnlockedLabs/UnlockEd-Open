...
function insertIntoUsers($db)
{
    ...
    ('e214a147-0d06-4322-9380-6bdd8c2367c0','superadmin', '$2y$10\$GdW0ms3ezuL4.Y5aA1eFKub59XEZNsgtiR0DOh76AghxmZzJ0L5La', 'superadmin@gmail.com', null, '1', '5');";
...
function insertIntoUserPreferences($db)
{
    ...
    ('e214a147-0d06-4322-9380-6bdd8c2367c0','superadmin', '1', 'light', '#8BC34A', '#37474F', '1');";
    $stmt = $db->prepare($load);
    try
    {
        $stmt->execute();
...
function insertIntoGamification($db)
{
    ...
    ('e214a147-0d06-4322-9380-6bdd8c2367c0','superadmin', '0', '0', '1', 'NEW USER', '0');";
    $stmt = $db->prepare($load);
    try
    {
        $stmt->execute();
